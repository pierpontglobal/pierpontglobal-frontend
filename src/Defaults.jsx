...
export const WebServer = process.env.NODE_ENV === 'development' ? 'http://ppm2.local:4000' : 'https://pierpontglobal.com';

// Automation test
export const AutomationUsername = 'leinadpb';
export const AutomationPassword = 'admin123';
